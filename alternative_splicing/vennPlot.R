...
storedColor <- c("#1b9e77", "#d95f02", "#7570b3", "#e7298a", "#66a61e")
if(length(inputFiles)==2){
    fillColor <- c(storedColor[1],storedColor[3])
}else if(length(inputFiles)==3){
    fillColor <- c(storedColor[1],storedColor[2],storedColor[3])
}else if(length(inputFiles)==4){
    fillColor <- c(storedColor[1],storedColor[2],storedColor[3],storedColor[4])
...
if(length(inputList)==1){
    ...
    cat.dist <- rep(0.04,2)
}else if(length(inputList)==3){
     cat.dist <- c(0.05, 0.05, 0.025)
}else if(length(inputList)==4){
    cat.dist <- c(0.22, 0.22, 0.11, 0.11)
}else if(length(inputList)==5){
    cat.dist <- rep(0.2, 5)
}else{
    write("Too many input lists", stderr())
}
